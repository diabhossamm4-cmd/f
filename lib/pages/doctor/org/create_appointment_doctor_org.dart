...
class CreateAppointmentDoctorOrg extends StatefulWidget {
  final int doctorId;
  final String orgType;

  const CreateAppointmentDoctorOrg(
      {Key key, @required this.doctorId, @required this.orgType})
      : super(key: key);

  @override
  _CreateAppointmentDoctorOrgState createState() =>
      _CreateAppointmentDoctorOrgState();
}

class _CreateAppointmentDoctorOrgState
    extends State<CreateAppointmentDoctorOrg> {
  String lang = "";
  final ReverstiotionDoctorOrgController controller =
      Get.put(ReverstiotionDoctorOrgController());
                ...
                : SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Obx(
                          () => Visibility(
                            visible: controller.selectedReversType.value ==
                                'by_time',
                            child: Row(
                              children: [
                                Text(
                                  AppLocalizations.of(context)
                                      .translate('reverstion_time'),
                                  style: TextStyle(fontSize: sizeWidth / 28),
                                ),
                                SizedBox(
                                  width: sizeWidth / 20,
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    controller: controller
                                        .reverstionDurationController.value,
                        ...
                        MyButton(
                          ...
                          onTap: () {
                            ...
                            controller.submitAndSaveAppointment(
                                context, widget.doctorId, widget.orgType);
                          },
                        ),
                        SizedBox(
                          height: sizeHeight / 30,
