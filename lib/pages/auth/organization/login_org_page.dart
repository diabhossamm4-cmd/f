...
class LoginOrgPage extends StatefulWidget {
  @override
  LoginOrgPageState createState() => LoginOrgPageState();
}

class LoginOrgPageState extends State<LoginOrgPage> {
  ...
  final controller = Get.put(AuthOrgController());
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => ForgotPasswordPage(isOrg: true),
                      ),
                    );
                  },
                  child: Text(
  ...
  void validateAndLogin() {
    ...
    if (_formKey.currentState.validate()) {
      UserLoginModel user = new UserLoginModel(
          email: _emailController.text, password: _passwordController.text, firebaseToken: _firebaseToken, rememberMe: _remember_me);
